    ...
    public class UiManager : SerializedSingleton<UiManager>
    {
            ...
            where TDialog : class, IDialog
        {
            if (dialogPrefabMap.ContainsKey(uiDialogId))
            {
                ...
                StartOpenDialog<TDialog>(uiDialogId, newDialog, overlayOnPrevious, dialogInitializer);
        ...
        private void StartOpenDialog<TDialog>(string uiDialogId, IDialog dialog, bool overlayOnPrevious, Action<TDialog> dialogInitializer)
        {
            ...
            if (TopOfDialogStack == dialog)
            {
                ...
                dialog.OnDialogOpen();
                dialogInitializer?.Invoke((TDialog)dialog);
