...
using System.Collections.Generic;
using System.Linq;
using POPBlocks.Server.Network.EpsilonServer;
using POPBlocks.Server.Network.PlayFab;
using UnityEngine;
    ...
    public class NetworkDataManager
    {
        ...
        public void DownloadPlayerData()
        {
            ...
            dataManager.GetLevels(value =>
            {
                ...
                {
                    int level = i;
                    int stars = PlayerPrefs.GetInt(LevelsMap._mapProgressManager.GetLevelKey(level), 0);
                    int score = PlayerPrefs.GetInt(LevelsMap._mapProgressManager.GetScoreKey(level), 0);
