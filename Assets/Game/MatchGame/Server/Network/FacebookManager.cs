        ...
        public void Share(int score)
        {
            ...
            else
            {
                FB.FeedShare(
                    ...
                    linkCaption: "I've got " +score + " scores! Try to beat me!"
                );
            }
        }
...
*/
        ...
        {
            FB.API("/me/picture?g&width=128&height=128&redirect=false", HttpMethod.GET,
...
//		Friends.Clear();
            ...
            foreach (var friendData in Friends)
            {
                if (friendData.picture != null)
                    GetPictureByURL(friendData.picture.data.url, friendData);
            }
