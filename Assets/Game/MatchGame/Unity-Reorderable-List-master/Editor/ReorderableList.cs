...
namespace Malee.List {
	...
	public class ReorderableList {
		...
		public ReorderableList(SerializedProperty list)
			: this(list, true, true, true, false) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, bool notExpandByDefault)
			: this(list, canAdd, canRemove, draggable, notExpandByDefault, ElementDisplayType.Auto, null, null, null) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, bool notExpandByDefault, ElementDisplayType elementDisplayType, string elementNameProperty, Texture
		 elementIcon)
			: this(list, canAdd, canRemove, draggable, notExpandByDefault, elementDisplayType, elementNameProperty, null, elementIcon) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, bool notExpandByDefault, ElementDisplayType elementDisplayType, string elementNameProperty, string 
		elementNameOverride, Texture elementIcon) {
			...
			id = GetHashCode();
			list.isExpanded = notExpandByDefault;
		...
		*/
		...
		private static string GetElementName(SerializedProperty element, string nameProperty, string nameOverride) {
			...
			if (!string.IsNullOrEmpty(nameOverride) && string.IsNullOrEmpty(nameProperty)) {
			...
			if (prop != null)
			{
				var propEnumDisplayName = PropEnumDisplayName(prop);
				if (propEnumDisplayName != null) return (nameOverride != "" ? nameOverride : "") + " " + propEnumDisplayName;
		...
		private static string PropEnumDisplayName(SerializedProperty prop)
		{
