			...
			if (array != null && array.isArray) {
				...
				if (!lists.TryGetValue(id, out list)) {
					...
					if (attrib != null) {
						...
						list = new ReorderableList(array, attrib.add, attrib.remove, attrib.draggable, attrib.expandByDefault, displayType, attrib.elementNameProperty, attrib
						.elementNameOverride, icon);
						...
						list = new ReorderableList(array, true, true, true, false);
					}
